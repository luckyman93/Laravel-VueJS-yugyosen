...
class CreateBoatsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('boats', function (Blueprint $table) {
            ...
            $table->string('boat_name_kana', 32)->nullable()->comment('船名(かな)');
            $table->string('fishing_area')->nullable()->comment('対応エリア');
            $table->integer('capacity')->nullable()->comment('最大定員');
            $table->string('departure')->nullable()->comment('出航時間');
            ...
            $table->string('boat_img_1', 128)->comment('船画像')->nullable();
