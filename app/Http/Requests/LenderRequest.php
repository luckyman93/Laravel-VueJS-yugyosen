...
class LenderRequest extends FormRequest
{
    ...
    public function rules()
    {
        // $test = $this->input();
        $rules = [
            'user.name' => 'nullable|string|max:32',
            'user.name_kana' => 'nullable|string|max:32',
            ...
            'zip_code' => 'nullable|string|max:8|regex:/^[0-9]{3}-[0-9]{4}$/',
            ...
            'boat_number' => 'nullable|integer',
            'other' => 'nullable',
            'boats.*.boat_name' => 'required|string|max:32',
            'boats.*.boat_name_kana' => 'nullable|string|max:32',
            'boats.*.fishing_area' => 'nullable|string',
            'boats.*.capacity' => 'nullable|integer',
            'boats.*.departure' => 'nullable|string',
            ...
            // 画像チェック
            'boat_image_list.0.image_src' => 'nullable',
