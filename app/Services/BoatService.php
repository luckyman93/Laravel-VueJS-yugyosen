...
class BoatService
{
     ...
     * 船 一覧取得
     */
    public function viewerIndex($sortKey, $orderBy, $prefectureParam, $cityParam, $portId): object
    {
        return $this->repository->index($sortKey, $orderBy, $prefectureParam, $cityParam, $portId);
    }
    /**
     * 船 詳細取得
     */
