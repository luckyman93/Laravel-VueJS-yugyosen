...
Vue.component('boatlist-component', require('./views/viewer/BoatList.vue').default)
Vue.component('boatdetail-component', require('./views/viewer/BoatDetail.vue').default)
