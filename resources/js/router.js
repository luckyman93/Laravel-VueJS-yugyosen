...
import AdminNewsDetail from '@/views/admin/NewsDetail.vue'
...
const routes = [
  ...
  /*-------------------------------------------*/
  {
    ...
    children: [
      ...
      {
        path: ROUTE.VIEWER.BOAT.LIST1.path,
        component: BoatList,
        name: ROUTE.VIEWER.BOAT.LIST1.name,
        meta: { viewerAuth: true },
        props: true,
      },
      {
        path: ROUTE.VIEWER.BOAT.LIST2.path,
        component: BoatList,
        name: ROUTE.VIEWER.BOAT.LIST2.name,
        meta: { viewerAuth: true },
        props: true,
      },
      {
  ...
  /*-------------------------------------------*/
  {
    ...
    children: [
      ...
      {
        path: ROUTE.ADMIN.NEWS.LIST.path,
        component: AdminNewsList,
        name: ROUTE.ADMIN.NEWS.LIST.name,
        meta: { adminAuth: true },
        props: true,
      },
      {
        path: ROUTE.ADMIN.NEWS.DETAIL.path,
